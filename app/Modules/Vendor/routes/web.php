...
Route::group(['module' => 'Vendor', 'middleware' => ['web'], 'namespace' => 'App\Modules\Vendor\Controllers'], function() {
  ...
  //  Route::get('vendor', 'VendorController');
    ...
    Route::post('/vendor/plan/final_calender', 'VendorController@final_calender'); 
    Route::post('/vendor/get_user_address_detail', 'VendorController@get_user_address_detail'); 
     Route::get('/vender/order-detail/{id}', 'VendorController@order_detail'); 
    Route::post('/vendor/order/get_user_meal_detail', 'VendorController@get_user_meal_detail'); 

    Route::get('/vendor/order-history', 'VendorController@order_history'); 
