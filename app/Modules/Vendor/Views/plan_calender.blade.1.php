    ...
    <div class="col-md-9">
        ...
        <div class="col-md-12">
            ...
            <select name="vendor_menu_category" id="vendor_menu_category" onchange="return changemeal(this.value)" data-placeholder="Select Menu Category" multiple  class="form-control select2">
             <option value="-1">Please select</option>
            </select>
            </div>
        </div>
        ...
        <div class="col-md-12">
                <div class="form-group">
                <label for="">Select Meal<span>*</span></label>
                <select name="vendor_plan_meal" id="vendor_plan_meal" data-placeholder="Select Meal" multiple  class="form-control select2">
                 <option value="-1">Please select</option>
                </select>
                </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <select name="vendor_menu_category_snacks" id="vendor_menu_category_snacks" onchange="return changemeal_snacks(this.value)" data-placeholder="Select Menu Category" multiple  class="form-control select2">
             <option value="-1">Please select</option>
            </select>
            </div>
        </div>
        ...
        <div class="col-md-12">
                <div class="form-group">
                <label for="">Select Meal<span>*</span></label>
                <select name="vendor_plan_meal_snacks" id="vendor_plan_meal_snacks" data-placeholder="Select Meal" multiple  class="form-control select2">
                 <option value="-1">Please select</option>
                </select>
                </div>
        </div>
