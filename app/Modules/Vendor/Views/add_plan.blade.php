	...
	$app_planfilter_id = $data[0]->app_planfilter_id; 
	$plan_image = $data[0]->plan_image; 
	$butttext = 'Update';
	$page_name = 'Edit Plan';       
	}
	else
   ...
   @endphp
	...
	<span class="error-msg" id="errorMsg"></span>
		...
		<img src="{{url('/')}}/public/vendor/upload/plan_image/{{$plan_image}}" alt="" class="img-responsive">
	</div>
	<label for="">Image</label>
	<input type="file" id="plan_image" onchange="uploadimg()" name="plan_image">
	</div>
	</div>
	...
	<div class="col-md-6">
	<div class="form-group">
	<label for="">Plan Description<span>*</span></label>
	<textarea name="plan_description" id="plan_description" cols="30" rows="5"><?php echo $plan_description; ?></textarea>
	</div>
	</div>
	...
	<input type="text" id="meal_count" maxlength="2" oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="meal_count" value="{{$vendor_plan_meals}}" class="form-control">
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
	<label for="">No. of snacks</label>
	<input type="text" id="snack_count" maxlength="2" oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="snack_count" value="{{$vendor_plan_snacks}}" class="form-control">
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
	...
	<input type="text" id="min_carb_macros_yes" maxlength="4" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{$macros_yes_min_carb}}" name="min_carb_macros_yes" class="form-control">
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
	<label for="">Max carb <span>*</span></label>
	<input type="text" id="max_carb_macros_yes" maxlength="4" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{$macros_yes_max_carb}}" name="max_carb_macros_yes" class="form-control">
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
	<label for="">Min protein <span>*</span></label>
	<input type="text" id="min_protien_macros_yes" maxlength="4" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{$macros_yes_min_protein}}" name="min_protien_macros_yes" class="form-control">
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
	<label for="">Max protein <span>*</span></label>
	<input type="text" id="max_protien_macros_yes" maxlength="4" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{$macros_yes_max_protein}}" name="max_protien_macros_yes" class="form-control">
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
	...
	<input type="text" id="max_carb_macros_no" maxlength="4" oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="max_carb_macros_no" value="{{$macros_no_max_carb}}"  class="form-control">
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
	<label for="">Max protein (For diet centers who provides fixed macros plans only)</label>
	<input type="text" id="max_protein_macros_no" maxlength="4" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{$macros_no_max_protein}}" name="max_protein_macros_no" class="form-control">
	</div>
	</div>
	</div>
	<div class="col-md-6">
	...
	<input type="text" id="cost_plan_package_feature" value="{{$cost_plan_package_feature}}" onkeypress="return isNumber(event)" maxlength="4" name="cost_plan_package_feature" class="form-control">
	</div>
	</div>
	...
	<input type="text" id="plan-duration" name="plan-duration" value="{{$vendor_plan_duration}}" maxlength="3" placeholder="Number of days" class="form-control">
	</div>
	</div> 
	...
	<div class="form-group">
	<input type="text" id="cost_plan" name="cost_plan" onkeypress="return isNumber(event)" maxlength="4" value="{{$plan_cost}}" class="form-control">
	</div>
	</div>
	...
	<div class="col-md-12">
		<div class="form-group">
		<label for="">Plan Filter Applied For ? <span>*</span></label>
		 @foreach($plan_filter_list as $filter_list_val)
		{{$filter_list_val->app_planfilter_name}} <input type="radio" class="plan_filter_class" name="plan_filter_name" id="" value="{{$filter_list_val->app_planfilter_id}}" @if($filter_list_val->app_planfilter_id==$app_planfilter_id) checked @endif  >
		 @endforeach
...
<!--add custom menu modal end-->
	...
	{                        
		...
		var plan_description = document.getElementById("plan_description").value.trim();
		...
		var  plan_image = $('#plan_image')[0].files[0];
	
	

		if(plan_image==null)
		{
		alert("Add plan image"); return false;
		}
		...
		if(plan_description=="")
		{
			document.getElementById('plan_description').style.border='1px solid #ff0000';
			document.getElementById("plan_description").focus();
			$('#plan_description').val('');
			$('#plan_description').attr("placeholder", "Please enter plan description");
			$("#plan_description").addClass( "errors" );
			return false;
		}
		else
		{
			document.getElementById("plan_description").style.border = "";   
		}
	...
	if ($(".plan_filter_class:radio:checked").length == 0)
	{
	  alert("Please select filter option"); return false;
	}
	else
	{
		var selectedplan_filter = $("input[name='plan_filter_name']:checked").val();
	}

	var form = new FormData(); 
	form.append('plan_name', plan_name); 
	form.append('plan_description', plan_description); 
...
//	form.append('custom_menu_list', custom_menu_list); 
	...
	form.append('selectedplan_filter', selectedplan_filter); 
	form.append('plan_image', plan_image); 
	 ...
	 <?php
	  ...
	  var Image_64byte="";
		...
		function uploadimg() 
		{
			...
			var e = document.getElementById("plan_image"),
			t = e.value,
			n = $("#plan_image")[0].files[0].size / 1024;
			if (n > 2048) return document.getElementById("image_name").value = " ", document.getElementById("plan_image").value = "", document.getElementById("errorMsg").style.color = "#ff0000", document.getElementById("errorMsg").innerHTML = "Image size should be less than 2mb", !1;
			var m = document.getElementById("plan_image").value,
			m = m.replace(/[&\/\\#,+()$~%.'":*?<>{}]/g, "_");
			...
			if (document.getElementById("errorMsg").style.color = "", document.getElementById("errorMsg").innerHTML = "", filesSelected = document.getElementById("plan_image").files, filesSelected.length > 0) {
