...
<section class="myDashboard">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<div class="rightBox">
					<h3 class="formTitle">Order History</h3>
                ...
                @php
                  $history_order_sql = DB::table('tbl_app_pre_order_calender')
                   ->where('app_pre_order_id',$order_list->app_pre_order_id)->orderBy('vendor_plandetail_date','desc')->first();
                  if( $history_order_sql->vendor_plandetail_date < $curDate )
                  {  
                @endphp
									<tr class="even-row">
										<td>{{++$i}}</td>
