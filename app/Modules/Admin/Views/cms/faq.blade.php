...
<div class="box-header">
                <a href="{{ url('lradmin/cms/add-faq') }}"> <button id="editable-sample_new" class="btn btn-warning btn-flat text-uppercase pull-right">
                        <i class="fa fa-plus"></i> <b>Add Faq</b>
                </button></a>
                </div>
...
<table id="example1" class="table table-bordered table-striped">
    ...
    <td>
      <a href="{{url('lradmin/cms/add-faq')}}/{{$lr_cms_id}}">
