...
@php
    ...
    $lr_category_description                 = $data[0]->lr_category_description;
...
<div class="box-body vendor-form">
    ...
    <div class="form-row">
    <label for="inputPassword3" class="control-label">Category Name</label>
    <textarea name="description" id="description" cols="60" rows="5">{{$lr_category_description}}</textarea>
