			...
			<div class="col-md-9">
				<div class="rightBox">
					<div class="headFlex">
						...
						<div class="addBtn">
							<a href="{{url('/add-meal')}}"><i class="fa fa-plus"></i> Add meal</a>
						</div>
					</div>
									...
									<tr class="even-row">
										...
										<td  class="meal-description">
											<span>
												...
												<a href="#"  data-toggle="modal" data-target="#readmoreModal">Read More</a>
											</span>
										</td>
										<td>XXX</td>
										<td>XXX</td>
...
<section class="inner-footer">
  ...
  <!-- Modal -->
  <div class="modal fade readmore-modal-area" id="readmoreModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<div class="reamode-modal-coantaeiner">
