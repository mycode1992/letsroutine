    ...
    <div class="row">
      <div class="col-md-12">
         ...
         <div class="box">
          ...
          <a href="{{url('/lradmin/export/exportvendor')}}/{{$page_name}}"> <button id="editable-sample_new" class="btn btn-warning btn-flat text-uppercase pull-right">
...
<table id="example1" class="table table-bordered table-striped">
    ...
    $count_plan = DB::table('tbl_lr_vendor_plan')->where('admin_status','!=','2')->where('lr_user_id',$lr_user_userid)->count();
     ...
     $count_packages = DB::table('tbl_lr_vendor_package')->where('admin_status','!=','2')->where('lr_user_id',$lr_user_userid)->count();
    ...
    <td><a href="{{url('lradmin/vendor/view-packages')}}/{{$lr_user_userid}}"><button class="btn btn-warning btn-flat text-uppercase pull-right">{{$count_packages}}<i class="fa fa-eye"></i><b> View Details</b></button></a></td>
